//_________________________ Inventors _____________________________//
const inventors = [
...
//_________________________ People _____________________________//
...
//_________________________ Travel Methods _____________________________//
const travelMethods = [
  'car',
  'car',
  'truck',
...
//_________________________ Devs _____________________________//
...
//_________________________ Comments _____________________________//
...
// I usually started with const and ignore the above code however this time I will use it just in case.
...
console.log('============================== Level Up Exercise 1 Solution ========================== ');
/*
...
//let inventor = inventors.passed - inventors.year;

const totalYearsLived = inventors.reduce(function(accumulator,inventor) {
...
console.log('============================== Level Up Exercise 2 Solution ========================== ');
/*
...
let travelMethodCounts = travelMethods.reduce(function(acc,travelMethod) {
  if (acc[travelMethod]) {
